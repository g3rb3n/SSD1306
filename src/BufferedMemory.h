#ifndef _BUFFERED_MEMORY_H_
#define _BUFFERED_MEMORY_H_
...
namespace g3rb3n
{
  ...
  class BufferedMemory : public GraphicalMemory
  {
    private:
      ByteIO* byteIO;
      uint8_t width;
    ...
    public:
      BufferedMemory(ByteIO* byteIO, uint8_t width, uint8_t height, uint8_t depth);
      ~BufferedMemory();
